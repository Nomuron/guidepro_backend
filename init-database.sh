...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
    ...
    CREATE SEQUENCE id_user_seq START WITH 22;
    CREATE SEQUENCE id_user_guide_seq START WITH 7;
    ...
    CREATE TABLE user_guide(
        id integer REFERENCES "user"(id) UNIQUE,
    ...
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (1, 'MIEJSKI', '1', 20, 'm', 'Z pasją odkrywam zakamarki świata, prowadząc Cię przez nieznane szlaki. Wędrowanie ze mną to nie tylko podróż, to spotkanie z historią, kulturą i niepowtarzalnymi doświadczeniami.', 'rolki, skateboard, spacery, zachody słońca');
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (2, 'MIEJSKI', '0', 30, 'f', 'Jako twój przewodnik, oferuję więcej niż tylko informacje. Zapraszam Cię na podróż, gdzie każdy krok to spotkanie z fascynującą historią, malowniczymi krajobrazami i autentycznymi smakami miejscowych kulinariów.', 'podróże do ryzykownych miejsc, gra w pasjansa, historia');
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (3, 'GÓRSKI', '1', 40, 'm', 'Moje opowieści odkrywają przed Tobą świat z zupełnie nowej perspektywy. Jako przewodnik staram się nie tylko przekazać informacje, ale również wprowadzić Cię w klimat każdego miejsca, które razem odkrywamy.', 'restauracje kuchni azjatyckiej, jazda na rowerze, box');
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (4, 'MUZEALNY', '1', 40, 'f', 'Podążając moimi śladami, zanurzysz się w niepowtarzalnych historiach, tajemniczych zakątkach i lokalnych zwyczajach. Razem z Tobą tworzę podróż pełną niezapomnianych chwil.', 'historia, książki, spacery, architektura');
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (5, 'TERENOWY', '1', 50, 'm', 'Jako pasjonat podróży i przewodnik, oferuję nie tylko zwiedzanie miejsc, ale autentyczne doświadczenia. Każde spotkanie ze mną to możliwość zgłębienia kultury, historii i smaków odległych krain.', 'bieg długodystansowy, natura, tenis, squash');
    INSERT INTO user_guide(id, guide_type, has_certificate, age, gender, about_me, interests) VALUES (6, 'MIEJSKI', '0', 50, 'n', 'W moim towarzystwie podróż staje się nie tylko widokiem, ale uczuciem. Przewodzę Cię z entuzjazmem przez zabytkowe uliczki, malownicze krajobrazy i unikalne doświadczenia, zawsze z myślą o Twojej wyjątkowej podróży.', 'książki, gra na gitarze, siatkówka');

    CREATE TABLE user_guide_language(
        id SERIAL NOT NULL PRIMARY KEY,
        user_guide_id integer REFERENCES "user"(id),
        language_id integer REFERENCES language(id)
    );

    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (1, 1, 1);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (2, 1, 2);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (3, 1, 3);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (4, 1, 4);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (5, 1, 5);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (6, 1, 6);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (7, 2, 1);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (8, 3, 2);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (9, 4, 3);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (10, 4, 4);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (11, 4, 5);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (12, 5, 1);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (13, 5, 2);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (14, 5, 3);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (15, 6, 1);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (16, 6, 4);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (17, 6, 5);
    INSERT INTO user_guide_language(id, user_guide_id, language_id) VALUES (18, 6, 6);
    ...
    CREATE TABLE trip(
        ...
        user_guide_id integer REFERENCES user_guide(id) NOT NULL,
        duration SMALLINT NOT NULL,
        language_id integer REFERENCES language(id) NOT NULL,
        price NUMERIC(8,2) NOT NULL,
        additional_fee text NOT NULL,
        max_people_amount SMALLINT NOT NULL,
        min_people_amount SMALLINT NOT NULL,
